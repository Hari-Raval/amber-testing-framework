...
def mk_rr_test(finput, prefix, t):
    ...
    cuda_test_generation.generate_cpp_test(finput, dir_name+"/"+name, chunk_rr)
    return get_data(dir_name+"/"+name + ".cpp")
...
def mk_chunked_test(finput, prefix, t):
    ...
    cuda_test_generation.generate_cpp_test(finput, dir_name+"/"+name, chunk_cfg)
    return get_data(dir_name+"/"+name + ".cpp")
...
def mk_plain_test(finput, prefix, t):
    ...
    cuda_test_generation.generate_cpp_test(finput, dir_name+"/"+name)
    return get_data(dir_name+"/"+name + ".cpp")
