...
def compare_results(data1, data2, csv1, csv2, name):
    different_results = []
    ...
    write_results(final_results, final_headers, name)


# output the formatted statistics between the two csvs in a .txt file named according to the data
def write_results(final_results, final_headers, name):
    today = date.today()
    output_name_txt = name + ".txt"
...
def main():
   ...
   # if csv1_headers != csv2_headers:
    ...
    compare_results(data1, data2, csv1, csv2, name)
